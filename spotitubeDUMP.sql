...
CREATE TABLE `playlists` (
  ...
  KEY `owner_idx` (`owner`),
  CONSTRAINT `owner` FOREIGN KEY (`owner`) REFERENCES `users` (`token`)
...
INSERT INTO `playlists` VALUES (1,'Harde tracks','66469626-7873-4383-8747-070f87be5120');
...
INSERT INTO `tracks` VALUES (1,'Kaas','Cedric',1000,'Kaasje',NULL,NULL,NULL,1);
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `token` FOREIGN KEY (`token`) REFERENCES `playlists` (`owner`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES ('cedritsj','wachtwoord','66469626-7873-4383-8747-070f87be5120');
...
-- Dump completed on 2023-10-03 11:10:11
